-- Deploy: schemas/dashboard_public/tables/user_actions/constraints/user_actions_verifier_status_id_fkey/constraint to pg
...
-- requires: schemas/dashboard_public/tables/user_actions/columns/verifier_status_id/column

BEGIN;

ALTER TABLE "dashboard_public".user_actions 
    ADD CONSTRAINT user_actions_verifier_status_id_fkey 
