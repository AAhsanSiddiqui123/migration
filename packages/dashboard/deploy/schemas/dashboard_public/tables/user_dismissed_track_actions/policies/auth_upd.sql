-- Deploy schemas/dashboard_public/tables/user_dismissed_track_actions/policies/auth_upd to pg
...
CREATE POLICY auth_upd ON dashboard_public.user_dismissed_track_actions
  FOR UPDATE
  TO authenticated
  USING (
