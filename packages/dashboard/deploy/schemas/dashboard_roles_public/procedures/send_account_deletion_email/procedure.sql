-- Deploy: schemas/dashboard_roles_public/procedures/send_account_deletion_email/procedure to pg
...
CREATE FUNCTION "dashboard_roles_public".send_account_deletion_email ()
    RETURNS boolean
AS $$
DECLARE
