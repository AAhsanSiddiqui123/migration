-- Deploy: schemas/dashboard_invites_public/tables/invites/triggers/invites_email_tg to pg
...
CREATE FUNCTION "dashboard_invites_private".invites_insert_before_tg()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE FUNCTION "dashboard_invites_private".invites_insert_after_tg()
RETURNS TRIGGER AS $$
DECLARE
