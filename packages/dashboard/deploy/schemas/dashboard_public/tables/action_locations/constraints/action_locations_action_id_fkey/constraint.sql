-- Deploy: schemas/dashboard_public/tables/action_locations/constraints/action_locations_action_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".action_locations 
    ADD CONSTRAINT action_locations_action_id_fkey 
