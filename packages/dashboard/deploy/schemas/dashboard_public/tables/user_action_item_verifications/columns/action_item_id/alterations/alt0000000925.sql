-- Deploy: schemas/dashboard_public/tables/user_action_item_verifications/columns/action_item_id/alterations/alt0000000925 to pg
...
ALTER TABLE "dashboard_public".user_action_item_verifications 
    ALTER COLUMN action_item_id SET DEFAULT uuid_nil();
COMMIT;
