-- Deploy: schemas/dashboard_memberships_private/trigger_fns/group_memberships_utg to pg
...
CREATE FUNCTION "dashboard_memberships_private".group_memberships_utg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
