-- Deploy: schemas/dashboard_memberships_public/tables/group_grants/triggers/timestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_memberships_public".group_grants
FOR EACH ROW
