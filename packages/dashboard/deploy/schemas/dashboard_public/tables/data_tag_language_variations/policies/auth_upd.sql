-- Deploy schemas/dashboard_public/tables/data_tag_language_variations/policies/auth_upd to pg
...
CREATE POLICY auth_upd ON dashboard_public.data_tag_language_variations
  FOR UPDATE
  TO authenticated
  USING 
  ( 
