-- Deploy: schemas/dashboard_memberships_private/trigger_fns/memberships_update_acl_tg to pg
...
CREATE FUNCTION "dashboard_memberships_private".memberships_update_acl_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    v_num_updated int;
