...
DROP TRIGGER IF EXISTS upsert_user_question_template_answers ON dashboard_public.user_answers;
DROP FUNCTION IF EXISTS dashboard_private.tg_upsert_user_question_template_answers; 
