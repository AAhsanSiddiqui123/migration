-- Deploy: schemas/dashboard_memberships_public/tables/app_owner_grants/triggers/timestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_memberships_public".app_owner_grants
FOR EACH ROW
