-- Deploy: schemas/dashboard_public/tables/impact_language_variations/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".impact_language_variations
FOR EACH ROW
