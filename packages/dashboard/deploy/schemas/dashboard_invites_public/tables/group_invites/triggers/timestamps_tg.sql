-- Deploy: schemas/dashboard_invites_public/tables/group_invites/triggers/timestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_invites_public".group_invites
FOR EACH ROW
