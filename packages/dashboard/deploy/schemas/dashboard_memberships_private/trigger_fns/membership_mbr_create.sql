-- Deploy: schemas/dashboard_memberships_private/trigger_fns/membership_mbr_create to pg
...
-- requires: schemas/dashboard_permissions_public/procedures/membership_permissions_get_mask_by_names/procedure

BEGIN;

CREATE FUNCTION "dashboard_memberships_private".membership_mbr_create ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
