-- Deploy: schemas/dashboard_public/tables/user_action_items/constraints/user_action_items_user_status_id_fkey/constraint to pg
...
-- requires: schemas/dashboard_public/tables/user_action_items/columns/user_status_id/column

BEGIN;

ALTER TABLE "dashboard_public".user_action_items 
    ADD CONSTRAINT user_action_items_user_status_id_fkey 
