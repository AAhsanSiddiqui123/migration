-- Deploy: schemas/dashboard_invites_public/tables/member_claimed_invites/triggers/timestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_invites_public".member_claimed_invites
FOR EACH ROW
