-- Deploy: schemas/dashboard_public/tables/group_goals/constraints/group_goals_impact_object_type_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".group_goals 
    ADD CONSTRAINT group_goals_impact_object_type_id_fkey 
