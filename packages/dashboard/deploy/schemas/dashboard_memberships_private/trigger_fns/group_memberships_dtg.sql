-- Deploy: schemas/dashboard_memberships_private/trigger_fns/group_memberships_dtg to pg
...
CREATE FUNCTION "dashboard_memberships_private".group_memberships_dtg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
    IF (
