-- Deploy: schemas/dashboard_public/tables/action_language_variations/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".action_language_variations
FOR EACH ROW
