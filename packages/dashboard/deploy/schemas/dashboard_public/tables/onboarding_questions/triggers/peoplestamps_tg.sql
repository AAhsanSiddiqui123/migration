-- Deploy: schemas/dashboard_public/tables/onboarding_questions/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".onboarding_questions
FOR EACH ROW
