-- Deploy: schemas/dashboard_roles_public/procedures/send_verification_email/procedure to pg
...
CREATE FUNCTION "dashboard_roles_public".send_verification_email(email email)
RETURNS boolean AS $$
DECLARE
