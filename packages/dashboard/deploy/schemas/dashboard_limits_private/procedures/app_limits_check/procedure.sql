-- Deploy: schemas/dashboard_limits_private/procedures/app_limits_check/procedure to pg
...
CREATE FUNCTION "dashboard_limits_private".app_limits_check (limitname citext, amount int default 1, user_id uuid default jwt_public.current_user_id())
  RETURNS BOOLEAN
AS $CODEZ$
DECLARE
