-- Deploy: schemas/dashboard_public/tables/user_saved_actions/constraints/user_saved_actions_user_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".user_saved_actions 
    ADD CONSTRAINT user_saved_actions_user_id_fkey 
    FOREIGN KEY (user_id)
