-- Deploy: schemas/dashboard_memberships_public/tables/group_membership_defaults/constraints/group_membership_defaults_entity_id_fkey/constraint to pg
...
-- requires: schemas/dashboard_memberships_public/tables/group_membership_defaults/columns/entity_id/column

BEGIN;

ALTER TABLE "dashboard_memberships_public".group_membership_defaults 
    ADD CONSTRAINT group_membership_defaults_entity_id_fkey 
