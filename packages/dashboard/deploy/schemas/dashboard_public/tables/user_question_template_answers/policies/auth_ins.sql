-- Deploy schemas/dashboard_public/tables/user_question_template_answers/policies/auth_ins to pg
...
CREATE POLICY auth_ins ON dashboard_public.user_question_template_answers
  FOR INSERT
  TO authenticated
   WITH CHECK (
