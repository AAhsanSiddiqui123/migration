-- Deploy: schemas/dashboard_memberships_public/tables/app_memberships/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_memberships_public".app_memberships
FOR EACH ROW
