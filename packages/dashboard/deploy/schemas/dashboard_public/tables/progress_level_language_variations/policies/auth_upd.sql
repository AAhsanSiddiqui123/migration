-- Deploy schemas/dashboard_public/tables/progress_level_language_variations/policies/auth_upd to pg
...
CREATE POLICY auth_upd ON dashboard_public.progress_level_language_variations
  FOR UPDATE
  TO authenticated
