-- Deploy schemas/dashboard_public/tables/progress_level_language_variations/policies/auth_ins to pg
...
CREATE POLICY auth_ins ON dashboard_public.progress_level_language_variations
  FOR INSERT
  TO authenticated
