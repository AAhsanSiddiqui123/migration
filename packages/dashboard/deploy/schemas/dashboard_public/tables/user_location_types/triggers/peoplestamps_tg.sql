-- Deploy: schemas/dashboard_public/tables/user_location_types/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".user_location_types
FOR EACH ROW
