-- Deploy: schemas/dashboard_memberships_private/trigger_fns/memberships_insert_acl_tg to pg
...
CREATE FUNCTION "dashboard_memberships_private".memberships_insert_acl_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
BEGIN
