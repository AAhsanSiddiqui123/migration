-- Deploy: schemas/dashboard_public/tables/user_pass_actions/constraints/user_pass_actions_owner_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".user_pass_actions 
    ADD CONSTRAINT user_pass_actions_owner_id_fkey 
