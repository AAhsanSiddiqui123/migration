-- Deploy: schemas/dashboard_memberships_private/procedures/group_memberships_perm_ids/procedure to pg
...
CREATE FUNCTION "dashboard_memberships_private".group_memberships_perm_ids (perm text)
  RETURNS uuid[]
AS $CODEZ$
