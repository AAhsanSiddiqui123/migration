-- Deploy: schemas/dashboard_public/tables/action_item_status_types/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".action_item_status_types
FOR EACH ROW
