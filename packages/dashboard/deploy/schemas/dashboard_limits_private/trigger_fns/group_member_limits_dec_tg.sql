-- Deploy: schemas/dashboard_limits_private/trigger_fns/group_member_limits_dec_tg to pg
...
CREATE FUNCTION "dashboard_limits_private".group_member_limits_dec_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    actor_id uuid;
