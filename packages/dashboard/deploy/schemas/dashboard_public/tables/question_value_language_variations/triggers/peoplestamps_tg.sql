-- Deploy: schemas/dashboard_public/tables/question_value_language_variations/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".question_value_language_variations
FOR EACH ROW
