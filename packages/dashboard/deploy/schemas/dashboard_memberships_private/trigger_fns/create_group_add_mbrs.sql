-- Deploy: schemas/dashboard_memberships_private/trigger_fns/create_group_add_mbrs to pg
...
-- requires: schemas/dashboard_permissions_public/procedures/group_member_permissions_get_mask_by_names/procedure

BEGIN;

CREATE FUNCTION "dashboard_memberships_private".create_group_add_mbrs ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
