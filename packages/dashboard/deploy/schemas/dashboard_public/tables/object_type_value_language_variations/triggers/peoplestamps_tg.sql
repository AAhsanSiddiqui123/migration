-- Deploy: schemas/dashboard_public/tables/object_type_value_language_variations/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".object_type_value_language_variations
FOR EACH ROW
