-- Deploy: schemas/dashboard_public/tables/track_language_variations/constraints/track_language_variations_owner_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".track_language_variations 
    ADD CONSTRAINT track_language_variations_owner_id_fkey 
