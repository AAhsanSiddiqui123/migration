-- Deploy: schemas/dashboard_memberships_private/procedures/memberships_mask_ids/procedure to pg
...
CREATE FUNCTION "dashboard_memberships_private".memberships_mask_ids (mask bit varying)
  RETURNS uuid[]
AS $CODEZ$
