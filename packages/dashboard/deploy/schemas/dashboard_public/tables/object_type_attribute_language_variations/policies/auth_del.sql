-- Deploy schemas/dashboard_public/tables/object_type_attribute_language_variations/policies/auth_del to pg
...
CREATE POLICY auth_del ON dashboard_public.object_type_attribute_language_variations
  FOR DELETE
  TO authenticated
  USING (
        (EXISTS ( SELECT 1
