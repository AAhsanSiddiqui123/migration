-- Deploy schemas/dashboard_public/tables/object_type_attribute_language_variations/policies/auth_upd to pg
...
CREATE POLICY auth_upd ON dashboard_public.object_type_attribute_language_variations
  FOR UPDATE
  TO authenticated
  USING (
        (EXISTS ( SELECT 1
