-- Deploy: schemas/dashboard_memberships_private/procedures/memberships_perm_check/procedure to pg
...
CREATE FUNCTION "dashboard_memberships_private".memberships_perm_check (perm text, entity_id uuid, actor_id uuid DEFAULT jwt_public.current_user_id())
  RETURNS boolean
AS $CODEZ$
SELECT EXISTS (
