-- Deploy: schemas/dashboard_memberships_private/procedures/app_memberships_mask_check/procedure to pg
...
CREATE FUNCTION "dashboard_memberships_private".app_memberships_mask_check (mask bit varying, actor_id uuid DEFAULT jwt_public.current_user_id())
  RETURNS boolean
AS $CODEZ$
    SELECT EXISTS (
