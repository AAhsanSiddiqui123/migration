-- Deploy: schemas/dashboard_memberships_public/tables/admin_grants/triggers/timestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_memberships_public".admin_grants
FOR EACH ROW
