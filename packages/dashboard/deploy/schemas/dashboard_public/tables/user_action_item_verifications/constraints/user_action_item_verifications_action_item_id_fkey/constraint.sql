-- Deploy: schemas/dashboard_public/tables/user_action_item_verifications/constraints/user_action_item_verifications_action_item_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".user_action_item_verifications 
    ADD CONSTRAINT user_action_item_verifications_action_item_id_fkey 
