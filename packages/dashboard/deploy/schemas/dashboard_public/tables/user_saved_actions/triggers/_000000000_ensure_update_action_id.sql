-- Deploy: schemas/dashboard_public/tables/user_saved_actions/triggers/_000000000_ensure_update_action_id to pg
-- made with <3 @ launchql.com

-- requires: schemas/dashboard_public/schema
-- requires: schemas/dashboard_private/schema
-- requires: schemas/dashboard_public/tables/user_saved_actions/table
-- requires: schemas/dashboard_private/trigger_fns/user_saved_actions_denorm_action_id
