-- Deploy: schemas/dashboard_public/tables/user_viewed_actions/constraints/user_viewed_actions_user_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".user_viewed_actions 
    ADD CONSTRAINT user_viewed_actions_user_id_fkey 
    FOREIGN KEY (user_id)
