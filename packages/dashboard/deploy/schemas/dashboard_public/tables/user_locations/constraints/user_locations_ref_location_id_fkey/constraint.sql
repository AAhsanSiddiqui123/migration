-- Deploy: schemas/dashboard_public/tables/user_locations/constraints/user_locations_ref_location_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".user_locations 
    ADD CONSTRAINT user_locations_ref_location_id_fkey 
