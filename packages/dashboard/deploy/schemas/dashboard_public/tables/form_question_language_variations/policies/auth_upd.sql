-- Deploy schemas/dashboard_public/tables/form_question_language_variations/policies/auth_upd to pg
...
CREATE POLICY auth_upd ON dashboard_public.form_question_language_variations
  FOR UPDATE
  TO authenticated
   USING (
