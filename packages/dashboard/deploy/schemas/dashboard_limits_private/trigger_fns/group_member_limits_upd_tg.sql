-- Deploy: schemas/dashboard_limits_private/trigger_fns/group_member_limits_upd_tg to pg
...
CREATE FUNCTION "dashboard_limits_private".group_member_limits_upd_tg ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    limit_ok boolean;
