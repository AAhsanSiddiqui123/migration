-- Deploy schemas/dashboard_public/tables/user_dismissed_track_actions/policies/auth_del to pg
...
CREATE POLICY auth_del ON dashboard_public.user_dismissed_track_actions
  FOR DELETE
  TO authenticated
  USING (
