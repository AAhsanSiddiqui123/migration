-- Deploy: schemas/dashboard_memberships_private/procedures/group_memberships_mask_ids/procedure to pg
...
CREATE FUNCTION "dashboard_memberships_private".group_memberships_mask_ids (mask bit varying)
  RETURNS uuid[]
AS $CODEZ$
