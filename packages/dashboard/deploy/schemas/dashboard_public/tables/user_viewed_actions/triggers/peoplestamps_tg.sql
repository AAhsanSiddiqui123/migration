-- Deploy: schemas/dashboard_public/tables/user_viewed_actions/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".user_viewed_actions
FOR EACH ROW
