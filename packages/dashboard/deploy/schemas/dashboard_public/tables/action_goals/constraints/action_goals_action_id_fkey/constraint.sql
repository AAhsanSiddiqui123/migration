-- Deploy: schemas/dashboard_public/tables/action_goals/constraints/action_goals_action_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".action_goals 
    ADD CONSTRAINT action_goals_action_id_fkey 
