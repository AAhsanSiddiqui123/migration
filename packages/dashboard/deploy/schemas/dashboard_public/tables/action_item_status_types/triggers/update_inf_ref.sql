-- Deploy: schemas/dashboard_public/tables/action_item_status_types/triggers/update_inf_ref to pg
-- made with <3 @ launchql.com

-- requires: schemas/dashboard_public/schema
-- requires: schemas/dashboard_private/schema
-- requires: schemas/dashboard_public/tables/action_item_status_types/table
-- requires: schemas/dashboard_private/trigger_fns/action_item_status_types_inf_ref
