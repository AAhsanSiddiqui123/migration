-- Deploy: schemas/dashboard_public/tables/related_actions/constraints/related_actions_action_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".related_actions 
    ADD CONSTRAINT related_actions_action_id_fkey 
