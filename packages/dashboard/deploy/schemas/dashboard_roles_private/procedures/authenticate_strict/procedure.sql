-- Deploy: schemas/dashboard_roles_private/procedures/authenticate_strict/procedure to pg
...
CREATE FUNCTION "dashboard_roles_private".authenticate_strict (token_str text)
