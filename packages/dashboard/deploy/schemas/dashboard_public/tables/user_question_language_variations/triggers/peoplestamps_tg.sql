-- Deploy: schemas/dashboard_public/tables/user_question_language_variations/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_public".user_question_language_variations
FOR EACH ROW
