-- Deploy schemas/dashboard_public/tables/user_question_template_answers/policies/auth_upd to pg
...
CREATE POLICY auth_upd ON dashboard_public.user_question_template_answers
  FOR UPDATE
  TO authenticated
  USING (
