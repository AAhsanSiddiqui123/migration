-- Deploy schemas/dashboard_public/tables/user_dismissed_track_actions/policies/auth_sel to pg
...
CREATE POLICY auth_sel ON dashboard_public.user_dismissed_track_actions
  FOR SELECT
  TO authenticated
  USING (
