-- Deploy: schemas/dashboard_invites_public/tables/group_invites/triggers/group_invites_email_tg to pg
...
CREATE FUNCTION "dashboard_invites_private".group_invites_insert_before_tg()
RETURNS TRIGGER AS $$
BEGIN
...
CREATE FUNCTION "dashboard_invites_private".group_invites_insert_after_tg()
RETURNS TRIGGER AS $$
DECLARE
    owner_id boolean;
...
INSERT ON
"dashboard_invites_public".group_invites FOR EACH ROW
