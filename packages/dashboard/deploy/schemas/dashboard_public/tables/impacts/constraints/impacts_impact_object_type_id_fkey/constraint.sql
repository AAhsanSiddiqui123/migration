-- Deploy: schemas/dashboard_public/tables/impacts/constraints/impacts_impact_object_type_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".impacts 
    ADD CONSTRAINT impacts_impact_object_type_id_fkey 
