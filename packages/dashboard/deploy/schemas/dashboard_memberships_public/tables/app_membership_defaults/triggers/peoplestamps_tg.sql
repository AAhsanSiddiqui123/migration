-- Deploy: schemas/dashboard_memberships_public/tables/app_membership_defaults/triggers/peoplestamps_tg to pg
...
BEFORE UPDATE OR INSERT ON "dashboard_memberships_public".app_membership_defaults
FOR EACH ROW
