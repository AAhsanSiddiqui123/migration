-- Deploy: schemas/dashboard_invites_public/procedures/submit_invite_code/procedure to pg
-- made with <3 @ launchql.com

-- requires: schemas/dashboard_invites_public/schema
-- requires: schemas/dashboard_memberships_public/tables/app_memberships/table
-- requires: schemas/dashboard_memberships_private/procedures/app_memberships_perm_check/procedure

BEGIN;

CREATE FUNCTION "dashboard_invites_public".submit_invite_code (
  token text
)
  RETURNS boolean
  AS $$
