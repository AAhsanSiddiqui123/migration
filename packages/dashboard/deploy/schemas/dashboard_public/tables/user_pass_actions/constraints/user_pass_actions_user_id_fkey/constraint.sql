-- Deploy: schemas/dashboard_public/tables/user_pass_actions/constraints/user_pass_actions_user_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".user_pass_actions 
    ADD CONSTRAINT user_pass_actions_user_id_fkey 
    FOREIGN KEY (user_id)
