-- Deploy: schemas/dashboard_memberships_private/trigger_fns/create_groups_add_mbrs to pg
...
CREATE FUNCTION "dashboard_memberships_private".create_groups_add_mbrs ()
  RETURNS TRIGGER
AS $CODEZ$
DECLARE
    gid uuid;
