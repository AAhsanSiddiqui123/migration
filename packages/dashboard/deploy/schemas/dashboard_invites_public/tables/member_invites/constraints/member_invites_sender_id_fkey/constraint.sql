-- Deploy: schemas/dashboard_invites_public/tables/member_invites/constraints/member_invites_sender_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_invites_public".member_invites 
    ADD CONSTRAINT member_invites_sender_id_fkey 
