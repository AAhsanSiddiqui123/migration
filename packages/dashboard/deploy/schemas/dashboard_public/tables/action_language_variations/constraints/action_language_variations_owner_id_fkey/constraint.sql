-- Deploy: schemas/dashboard_public/tables/action_language_variations/constraints/action_language_variations_owner_id_fkey/constraint to pg
...
ALTER TABLE "dashboard_public".action_language_variations 
    ADD CONSTRAINT action_language_variations_owner_id_fkey 
