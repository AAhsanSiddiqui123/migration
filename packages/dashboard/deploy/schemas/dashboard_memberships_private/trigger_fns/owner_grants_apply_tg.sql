-- Deploy: schemas/dashboard_memberships_private/trigger_fns/owner_grants_apply_tg to pg
...
CREATE FUNCTION "dashboard_memberships_private".owner_grants_apply_tg ()
  RETURNS TRIGGER
AS $CODEZ$
BEGIN
