-- Deploy: schemas/dashboard_invites_public/procedures/submit_member_invite_code/procedure to pg
...
CREATE FUNCTION "dashboard_invites_public".submit_member_invite_code (
  token text
)
  RETURNS boolean
  AS $$
